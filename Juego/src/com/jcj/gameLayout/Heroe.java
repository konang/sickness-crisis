...
public class Heroe extends DynamicGameObject {
    ...
    public static final int SALTO_HEROEDER = 10;           //Velocidad vertical
    public static final int SALTO_HEROEIZQ = 11; 
     ...
     * En el constructor de clase Heroe definimos el estado inicial del objeto asi como también llamamos
    ...
    /*
     * Método update.
     * El método update se encarga de actualizar los atributos de la clase Heroe,
